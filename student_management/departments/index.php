...
<button class="btn btn-warning btn-sm editBtn"
    ...
    data-info="<?= htmlspecialchars($d['info']) ?>"
    data-bs-toggle="modal"
...
<a href="delete.php?id=<?= $d['id'] ?>"
   ...
   onclick="return confirm('Xóa khoa?')">
   Xóa
</a>
</td>
<?php endif; ?>
...
<textarea name="info" id="edit-info" class="form-control" rows="4"></textarea>
</div>
...
document.querySelectorAll('.editBtn').forEach(btn=>{
  btn.addEventListener('click',()=>{
    ...
    document.getElementById('edit-info').value = btn.dataset.info;
  });
});
</script>
